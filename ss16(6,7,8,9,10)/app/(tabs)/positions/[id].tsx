import { getPositionById } from "@/apis/position.api";
...
export default function PositionDetailScreen() {
  ...
  const { currentPosition, status, error } = useAppSelector(
  ...
  const isActive = currentPosition.positionStatus === "ACTIVE";

  return (
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.label}>Tên vị trí</Text>
        <Text style={styles.valueName}>{currentPosition.positionName}</Text>
